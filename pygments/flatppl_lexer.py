...
# GEN:specialops-end
# GEN:kernels-start
KERNELS = ("Uniform", "Normal", "GeneralizedNormal", "Cauchy", "StudentT", "Logistic", "LogNormal", "Exponential", "Gamma", "Weibull", "InverseGamma", "Beta", "ChiSquared", "VonMises", "Laplace", "Bernoulli", "Categorical", "Categorical0", "Binomial", "Poisson", "Geometric", "NegativeBinomial", "NegativeBinomial2", "MvNormal", "Wishart", "InverseWishart", "LKJ", "LKJCholesky", "Dirichlet", "Multinomial", "PoissonProcess", "BinnedPoissonProcess", "Dirac", "Lebesgue", "Counting")
# GEN:kernels-end
# GEN:combinators-start
COMBINATORS = ("weighted", "logweighted", "normalize", "totalmass", "superpose", "joint", "jointchain", "kchain", "markovchain", "kscan", "iid", "truncate", "pushfwd", "locscale")
# GEN:combinators-end
# GEN:analysis-start
